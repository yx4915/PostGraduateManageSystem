    ...
    <div class="form-section">
        ...
        <form action="updateStudentInfo" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="studentID" name="studentID" value="${user.studentID}" readonly>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="namePY" name="namePY" value="${user.namePY}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="politicalStatus" name="politicalStatus" value="${user.politicalStatus}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="IDType" name="IDType" value="${user.IDType}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="maritalStatus" name="maritalStatus">
                        <option value="未婚" ${user.maritalStatus == '未婚' ? 'selected' : ''}>未婚</option>
                        <option value="已婚" ${user.maritalStatus == '已婚' ? 'selected' : ''}>已婚</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="familyAddress" name="familyAddress" value="${user.familyAddress}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="campusEmail" name="campusEmail" value="${user.campusEmail}">
                </div>
            </div>
            <div class="form-group row">
                <label for="personalEmail" class="col-sm-2 col-form-label">宿舍号</label>
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="personalEmail" name="personalEmail" value="${user.personalEmail}">
                </div>
            </div>
            <div class="form-group row">
                <label for="joinPartyDate" class="col-sm-2 col-form-label">入党日期</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="joinPartyDate" name="joinPartyDate" value="${user.joinPartyDate}">
                </div>
            </div>
